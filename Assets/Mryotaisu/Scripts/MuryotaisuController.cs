...
namespace Muryotaisu
{
    public class MuryotaisuController : MonoBehaviour
    {
        ...
        {
            //スティック操作
            float sidestick = Input.GetAxis("Horizontal");
            float verticalstick = Input.GetAxis("Vertical");
            ...
            if (controller.isGrounded)
            {
                ...
                //if (Input.GetKey("up") || Input.GetKey("w") || verticalstick>0)
                //{
                ...
                if (Input.GetKey("right") || Input.GetKey("d") || sidestick>0)
                {
                ...
                if (Input.GetKey("down") || Input.GetKey("s") || verticalstick<0) 
                {
                ...
                if (Input.GetKey("left") || Input.GetKey("a") || sidestick<0) 
                {
                    float angleDiff = Mathf.DeltaAngle(transform.localEulerAngles.y, 90);
